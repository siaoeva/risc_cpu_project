...
void Vregfile___024root___trigger_orInto__act(VlUnpacked<QData/*63:0*/, 1> &out, const VlUnpacked<QData/*63:0*/, 1> &in) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vregfile___024root___trigger_orInto__act\n"); );
    // Locals
    IData/*31:0*/ n;
    // Body
    n = 0U;
...
bool Vregfile___024root___eval_phase__act(Vregfile___024root* vlSelf) {
    ...
    Vregfile___024root___trigger_orInto__act(vlSelfRef.__VnbaTriggered, vlSelfRef.__VactTriggered);
    __VactExecute = Vregfile___024root___trigger_anySet__act(vlSelfRef.__VactTriggered);
    if (__VactExecute) {
...
void Vregfile___024root___eval(Vregfile___024root* vlSelf) {
    ...
    do {
        ...
        } while (Vregfile___024root___eval_phase__act(vlSelf));
    } while (Vregfile___024root___eval_phase__nba(vlSelf));
}
