...
void Vcpu_defs___024root__trace_chg_0_sub_0(Vcpu_defs___024root* vlSelf, VerilatedVcd::Buffer* bufp);

void Vcpu_defs___024root__trace_chg_0(void* voidSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcpu_defs___024root__trace_chg_0\n"); );
    // Body
    ...
    Vcpu_defs___024root__trace_chg_0_sub_0((&vlSymsp->TOP), bufp);
}

void Vcpu_defs___024root__trace_chg_0_sub_0(Vcpu_defs___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcpu_defs___024root__trace_chg_0_sub_0\n"); );
    Vcpu_defs__Syms* const __restrict vlSymsp VL_ATTR_UNUSED = vlSelf->vlSymsp;
...
void Vcpu_defs___024root__trace_cleanup(void* voidSelf, VerilatedVcd* /*unused*/) {
    VL_DEBUG_IF(VL_DBG_MSGF("+    Vcpu_defs___024root__trace_cleanup\n"); );
    // Locals
